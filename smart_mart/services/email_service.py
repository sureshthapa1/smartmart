...
def _gemini_personalised_email_section(items: list) -> str:
...
def send_order_confirmation(order, items: list) -> bool:
    ...
    try:
        ...
        # Generate Gemini personalisation (non-blocking — empty string if fails)
        personalised_tips = _gemini_personalised_email_section(items)
